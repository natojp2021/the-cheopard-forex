"""zband_nzdcad.py — ZBandNZDCADM30

NZDCAD · M30 · BOTH · Z-Band Mean Reversion (Ornstein-Uhlenbeck, không cắt lỗ theo giá)
...
KẾT QUẢ   Sharpe 0.577 ALL · 0.657 FORM · 0.438 OOS · net 3.17 bps/lệnh (t = 1.79) ·
          thắng 70.2% · 6/7 năm dương
TẦN SUẤT  830 lệnh trong 6.5 năm ≈ 127 lệnh/năm · giữ 96 nến M30
...
EXPECTANCY = (
    "Sharpe 0.577 ALL · 0.657 FORM · 0.438 OOS · net 3.17 bps/lệnh (t = 1.79) · thắng "
    "70.2% · 6/7 năm dương"
)
FREQUENCY = "830 lệnh trong 6.5 năm ≈ 127 lệnh/năm"

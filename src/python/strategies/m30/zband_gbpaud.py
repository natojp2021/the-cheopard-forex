"""zband_gbpaud.py — ZBandGBPAUDM30

GBPAUD · M30 · BOTH · Z-Band Mean Reversion (Ornstein-Uhlenbeck, không cắt lỗ theo giá)

┌─ QUY TẮC VÀO LỆNH ────────────────────────────────────────────────────────────┐
│  VÀO   (đủ CẢ)                                                                │
│     a. |z| > 2.5                                                              │
│     b. nến TRƯỚC cũng ngoài dải: |z(t−1)| > 2.5                               │
│     c. z < −2.5 → MUA · z > +2.5 → BÁN                                        │
│     → khớp tại giá MỞ CỬA nến kế tiếp sau nến tín hiệu                        │
│                                                                               │
│  THOÁT                                                                        │
│     · z về 0                                                                  │
│     · time-stop 96 nến M30                                                    │
...
KẾT QUẢ   Sharpe 0.910 ALL · 0.879 FORM · 1.007 OOS · net 8.06 bps/lệnh (t = 2.83) ·
          thắng 68.6% · 6/7 năm dương
TẦN SUẤT  373 lệnh trong 6.5 năm ≈ 57 lệnh/năm · giữ 96 nến M30
...
EXPECTANCY = (
    "Sharpe 0.910 ALL · 0.879 FORM · 1.007 OOS · net 8.06 bps/lệnh (t = 2.83) · thắng "
    "68.6% · 6/7 năm dương"
)
FREQUENCY = "373 lệnh trong 6.5 năm ≈ 57 lệnh/năm"

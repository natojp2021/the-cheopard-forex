"""rsi_div_gbpnzd.py — RsiDivGBPNZDM30

GBPNZD · M30 · BOTH · Phân kỳ giá/RSI (quan hệ giữa hai chuỗi)
...
│     · time-stop 192 nến M30                                                   │
│                                                                               │
│  CẮT LỖ  KHÔNG có SL theo giá — rủi ro quản bằng CỠ VỊ THẾ và time-stop       │
│  VỊ THẾ  tối đa 1                                                             │
└───────────────────────────────────────────────────────────────────────────────┘

KẾT QUẢ   Sharpe 1.164 ALL · 1.476 FORM · 0.617 OOS · net 20.44 bps/lệnh (t = 3.64) ·
          thắng 61.3% · 7/7 năm dương
TẦN SUẤT  297 lệnh trong 6.5 năm ≈ 46 lệnh/năm · giữ tối đa 192 nến M30
CHỈ BÁO   RSI(14) của giá đóng cửa · cực trị 192 nến của GIÁ và của RSI, so riêng
...
EXPECTANCY = (
    "Sharpe 1.164 ALL · 1.476 FORM · 0.617 OOS · net 20.44 bps/lệnh (t = 3.64) · thắng "
    "61.3% · 7/7 năm dương"
)
FREQUENCY = "297 lệnh trong 6.5 năm ≈ 46 lệnh/năm"

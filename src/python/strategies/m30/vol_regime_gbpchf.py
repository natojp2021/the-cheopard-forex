"""vol_regime_gbpchf.py — VolRegimeGBPCHFM30

GBPCHF · M30 · BOTH · Chế độ biến động (tỷ số σ ngắn / σ dài)

┌─ QUY TẮC VÀO LỆNH ────────────────────────────────────────────────────────────┐
│  VÀO   (đủ CẢ)                                                                │
│     a. σ(24 nến) / σ(96 nến) > 1.6                                           │
│     b. tổng lợi nhuận 24 nến gần nhất < 0 → MUA · > 0 → BÁN                   │
...
KẾT QUẢ   Sharpe 0.864 ALL · 0.712 FORM · 1.173 OOS · net 22.06 bps/lệnh (t = 2.83) ·
          thắng 66.2% · 6/7 năm dương
TẦN SUẤT  68 lệnh trong 6.2 năm ≈ 11 lệnh/năm · giữ tối đa 48 nến M30
CHỈ BÁO   σ ngắn hạn: độ lệch chuẩn lợi nhuận log 24 nến · σ dài hạn: độ lệch chuẩn 96
          nến
...
EXPECTANCY = (
    "Sharpe 0.864 ALL · 0.712 FORM · 1.173 OOS · net 22.06 bps/lệnh (t = 2.83) · thắng "
    "66.2% · 6/7 năm dương"
)
FREQUENCY = "68 lệnh trong 6.2 năm ≈ 11 lệnh/năm"

"""zband_audcad.py — ZBandAUDCADM30

AUDCAD · M30 · BOTH · Z-Band Mean Reversion (Ornstein-Uhlenbeck, không cắt lỗ theo giá)
...
KẾT QUẢ   Sharpe 0.699 ALL · 0.689 FORM · 0.721 OOS · net 3.56 bps/lệnh (t = 2.13) ·
          thắng 69.0% · 6/7 năm dương
TẦN SUẤT  849 lệnh trong 6.5 năm ≈ 130 lệnh/năm · giữ 96 nến M30
...
EXPECTANCY = (
    "Sharpe 0.699 ALL · 0.689 FORM · 0.721 OOS · net 3.56 bps/lệnh (t = 2.13) · thắng "
    "69.0% · 6/7 năm dương"
)
FREQUENCY = "849 lệnh trong 6.5 năm ≈ 130 lệnh/năm"

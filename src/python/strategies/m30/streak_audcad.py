"""streak_audcad.py — StreakAUDCADM30

AUDCAD · M30 · BOTH · Chuỗi nến cùng chiều (đếm, miễn nhiễm với độ lớn)

┌─ QUY TẮC VÀO LỆNH ────────────────────────────────────────────────────────────┐
│  VÀO   (đủ CẢ)                                                                │
│     a. chuỗi ≥ 4 nến cùng chiều liên tiếp                                     │
│     b. tổng dịch chuyển > 0.5 × ATR × √4                                      │
│     c. chuỗi 4 nến GIẢM → MUA · 4 nến TĂNG → BÁN                              │
...
KẾT QUẢ   Sharpe 0.920 ALL · 1.123 FORM · 0.538 OOS · net 6.63 bps/lệnh (t = 2.96) ·
          thắng 62.9% · 7/7 năm dương
TẦN SUẤT  680 lệnh trong 6.5 năm ≈ 104 lệnh/năm · giữ tối đa 192 nến M30
...
EXPECTANCY = (
    "Sharpe 0.920 ALL · 1.123 FORM · 0.538 OOS · net 6.63 bps/lệnh (t = 2.96) · thắng "
    "62.9% · 7/7 năm dương"
)
FREQUENCY = "680 lệnh trong 6.5 năm ≈ 104 lệnh/năm"

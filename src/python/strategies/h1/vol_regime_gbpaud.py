"""vol_regime_gbpaud.py — VolRegimeGBPAUDH1

GBPAUD · H1 · BOTH · Chế độ biến động (tỷ số σ ngắn / σ dài)

┌─ QUY TẮC VÀO LỆNH ────────────────────────────────────────────────────────────┐
│  VÀO   (đủ CẢ)                                                                │
│     a. σ(24 nến) / σ(96 nến) > 1.3                                           │
...
KẾT QUẢ   Sharpe 0.785 ALL · 0.803 FORM · 0.772 OOS · net 8.45 bps/lệnh (t = 2.30) ·
          thắng 65.0% · 6/7 năm dương
TẦN SUẤT  246 lệnh trong 6.5 năm ≈ 38 lệnh/năm · giữ tối đa 24 nến H1
...
EXPECTANCY = (
    "Sharpe 0.785 ALL · 0.803 FORM · 0.772 OOS · net 8.45 bps/lệnh (t = 2.30) · thắng "
    "65.0% · 6/7 năm dương"
)
FREQUENCY = "246 lệnh trong 6.5 năm ≈ 38 lệnh/năm"

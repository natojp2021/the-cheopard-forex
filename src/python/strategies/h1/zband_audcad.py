"""zband_audcad.py — ZBandAUDCADH1

AUDCAD · H1 · BOTH · Z-Band Mean Reversion (Ornstein-Uhlenbeck, không cắt lỗ theo giá)
...
KẾT QUẢ   Sharpe 0.583 ALL · 0.639 FORM · 0.491 OOS · net 3.51 bps/lệnh (t = 1.78) ·
          thắng 67.8% · 6/7 năm dương
TẦN SUẤT  677 lệnh trong 6.5 năm ≈ 104 lệnh/năm · giữ 48 nến H1
...
EXPECTANCY = (
    "Sharpe 0.583 ALL · 0.639 FORM · 0.491 OOS · net 3.51 bps/lệnh (t = 1.78) · thắng "
    "67.8% · 6/7 năm dương"
)
FREQUENCY = "677 lệnh trong 6.5 năm ≈ 104 lệnh/năm"

"""zband_nzdcad.py — ZBandNZDCADH1

NZDCAD · H1 · BOTH · Z-Band Mean Reversion (Ornstein-Uhlenbeck, không cắt lỗ theo giá)
...
KẾT QUẢ   Sharpe 0.694 ALL · 0.725 FORM · 0.642 OOS · net 4.39 bps/lệnh (t = 2.14) ·
          thắng 69.4% · 6/7 năm dương
TẦN SUẤT  693 lệnh trong 6.5 năm ≈ 106 lệnh/năm · giữ 48 nến H1
CHỈ BÁO   z = (log giá − trung bình 48 nến) / độ lệch chuẩn 48 nến · time-stop = 48 nến
          H1
...
EXPECTANCY = (
    "Sharpe 0.694 ALL · 0.725 FORM · 0.642 OOS · net 4.39 bps/lệnh (t = 2.14) · thắng "
    "69.4% · 6/7 năm dương"
)
FREQUENCY = "693 lệnh trong 6.5 năm ≈ 106 lệnh/năm"

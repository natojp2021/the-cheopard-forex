"""streak_gbpcad.py — StreakGBPCADH1

GBPCAD · H1 · BOTH · Chuỗi nến cùng chiều (đếm, miễn nhiễm với độ lớn)

┌─ QUY TẮC VÀO LỆNH ────────────────────────────────────────────────────────────┐
│  VÀO   (đủ CẢ)                                                                │
│     a. chuỗi ≥ 5 nến cùng chiều liên tiếp                                     │
│     b. tổng dịch chuyển > 0.5 × ATR × √5                                      │
│     c. chuỗi 5 nến GIẢM → MUA · 5 nến TĂNG → BÁN                              │
...
KẾT QUẢ   Sharpe 0.815 ALL · 1.014 FORM · 0.399 OOS · net 6.43 bps/lệnh (t = 2.53) ·
          thắng 57.0% · 6/7 năm dương
TẦN SUẤT  426 lệnh trong 6.5 năm ≈ 65 lệnh/năm · giữ tối đa 24 nến H1
...
EXPECTANCY = (
    "Sharpe 0.815 ALL · 1.014 FORM · 0.399 OOS · net 6.43 bps/lệnh (t = 2.53) · thắng "
    "57.0% · 6/7 năm dương"
)
FREQUENCY = "426 lệnh trong 6.5 năm ≈ 65 lệnh/năm"

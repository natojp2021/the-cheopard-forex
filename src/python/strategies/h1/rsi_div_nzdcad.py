"""rsi_div_nzdcad.py — RsiDivNZDCADH1

NZDCAD · H1 · BOTH · Phân kỳ giá/RSI (quan hệ giữa hai chuỗi)

┌─ QUY TẮC VÀO LỆNH ────────────────────────────────────────────────────────────┐
│  VÀO   (đủ CẢ)                                                                │
│     a. giá lập cực trị mới so với 96 nến trước                                │
│     b. RSI lệch ít nhất 6.0 điểm khỏi cực trị RSI cùng cửa sổ                 │
│     c. giá ĐÁY mới + RSI cao hơn đáy RSI ≥ 6.0 điểm → MUA · giá ĐỈNH mới + RSI │
│        thấp hơn đỉnh RSI ≥ 6.0 điểm → BÁN                                     │
...
KẾT QUẢ   Sharpe 0.681 ALL · 0.688 FORM · 0.680 OOS · net 6.05 bps/lệnh (t = 2.10) ·
          thắng 52.8% · 6/7 năm dương
TẦN SUẤT  341 lệnh trong 6.5 năm ≈ 52 lệnh/năm · giữ tối đa 24 nến H1
...
EXPECTANCY = (
    "Sharpe 0.681 ALL · 0.688 FORM · 0.680 OOS · net 6.05 bps/lệnh (t = 2.10) · thắng "
    "52.8% · 6/7 năm dương"
)
FREQUENCY = "341 lệnh trong 6.5 năm ≈ 52 lệnh/năm"

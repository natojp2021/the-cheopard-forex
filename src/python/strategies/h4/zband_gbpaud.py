"""zband_gbpaud.py — ZBandGBPAUDH4

GBPAUD · H4 · BOTH · Z-Band Mean Reversion (Ornstein-Uhlenbeck, không cắt lỗ theo giá)
...
KẾT QUẢ   Sharpe 0.730 ALL · 0.898 FORM · 0.422 OOS · net 8.39 bps/lệnh (t = 2.26) ·
          thắng 68.6% · 7/7 năm dương
TẦN SUẤT  354 lệnh trong 6.5 năm ≈ 54 lệnh/năm · giữ 72 nến H4
...
EXPECTANCY = (
    "Sharpe 0.730 ALL · 0.898 FORM · 0.422 OOS · net 8.39 bps/lệnh (t = 2.26) · thắng "
    "68.6% · 7/7 năm dương"
)
FREQUENCY = "354 lệnh trong 6.5 năm ≈ 54 lệnh/năm"

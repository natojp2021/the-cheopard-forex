"""zband_gbpnzd.py — ZBandGBPNZDH4

GBPNZD · H4 · BOTH · Z-Band Mean Reversion (Ornstein-Uhlenbeck, không cắt lỗ theo giá)
...
KẾT QUẢ   Sharpe 1.077 ALL · 1.290 FORM · 0.673 OOS · net 7.24 bps/lệnh (t = 3.35) ·
          thắng 68.0% · 6/7 năm dương
TẦN SUẤT  541 lệnh trong 6.5 năm ≈ 83 lệnh/năm · giữ 12 nến H4
CHỈ BÁO   z = (log giá − trung bình 12 nến) / độ lệch chuẩn 12 nến · time-stop = 12 nến
          H4
...
EXPECTANCY = (
    "Sharpe 1.077 ALL · 1.290 FORM · 0.673 OOS · net 7.24 bps/lệnh (t = 3.35) · thắng "
    "68.0% · 6/7 năm dương"
)
FREQUENCY = "541 lệnh trong 6.5 năm ≈ 83 lệnh/năm"

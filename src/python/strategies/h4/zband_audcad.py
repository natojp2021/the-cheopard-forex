"""zband_audcad.py — ZBandAUDCADH4

AUDCAD · H4 · BOTH · Z-Band Mean Reversion (Ornstein-Uhlenbeck, không cắt lỗ theo giá)
...
KẾT QUẢ   Sharpe 1.036 ALL · 1.038 FORM · 1.036 OOS · net 13.42 bps/lệnh (t = 3.23) ·
          thắng 68.7% · 7/7 năm dương
TẦN SUẤT  214 lệnh trong 6.5 năm ≈ 33 lệnh/năm · giữ 48 nến H4
CHỈ BÁO   z = (log giá − trung bình 24 nến) / độ lệch chuẩn 24 nến · time-stop = 48 nến
          H4
...
EXPECTANCY = (
    "Sharpe 1.036 ALL · 1.038 FORM · 1.036 OOS · net 13.42 bps/lệnh (t = 3.23) · thắng "
    "68.7% · 7/7 năm dương"
)
FREQUENCY = "214 lệnh trong 6.5 năm ≈ 33 lệnh/năm"
